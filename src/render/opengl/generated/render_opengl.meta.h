...
"uniform float u_sample_is_surface;\n"
"\n"
"void main(void)\n"
"{\n"
"  // rjf: constants\n"
...
"    if(u_sample_is_surface > 0.5f)\n"
"    {\n"
"      // surface textures are rendered through the y-flipped projection above, so\n"
"      // their rows are bottom-up relative to uploaded textures; flip the sample\n"
"      v2p_texcoord_pct.y = 1.f - v2p_texcoord_pct.y;\n"
"    }\n"
