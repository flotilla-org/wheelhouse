...
internal R_Rect2DInst *dr_surface_img_sub(R_Handle target, Rng2F32 dst, Rng2F32 src_uv, Vec4F32 color, F32 corner_radius, F32 border_thickness, F32 edge_softness); // src_uv: subrect of the surface, 0..1
