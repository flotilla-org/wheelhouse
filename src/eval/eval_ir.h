...
internal void e_oplist_push_op(Arena *arena, E_OpList *list, E_BytecodeOp opcode, E_Value value);
...
internal E_IRNode *e_push_irnode(Arena *arena, E_BytecodeOp op);
...
internal E_IRNode *e_irtree_unary_op(Arena *arena, E_BytecodeOp op, E_TypeGroup group, E_IRNode *c);
internal E_IRNode *e_irtree_binary_op(Arena *arena, E_BytecodeOp op, E_TypeGroup group, U64 operand_size, E_IRNode *l, E_IRNode *r);
internal E_IRNode *e_irtree_binary_op_u(Arena *arena, E_BytecodeOp op, U64 operand_size, E_IRNode *l, E_IRNode *r);
...
internal E_IRNode *e_irtree_convert_lo(Arena *arena, E_IRNode *c, E_TypeGroup out, E_TypeGroup in);
